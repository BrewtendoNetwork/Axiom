...
Result TEST::unloadAccount(MainStruct *mainStruct) {
    Result rc = 0;
...
Result TEST::switchAccounts(MainStruct *mainStruct, u8 friend_account_id) {
    Result rc = 0;
...
Result TEST::createAccount(MainStruct *mainStruct, u8 friend_account_id, NascEnvironment environmentId) {
    Result rc = 0;
...
void TEST::migrateAccount(MainStruct *mainStruct) {
    Result rc = 0;
...
void TEST::unlinkBNID(MainStruct *mainStruct) {
...
void TEST::launchPlugin(MainStruct *mainStruct) {
    Result rc = 0;
...
void TEST::openPrompt(MainStruct* mainStruct, const std::string& message, PromptStatus promptStatus)
{
...
void TEST::updatePrompt(MainStruct* mainStruct, u32 kDown)
{
...
void TEST::drawPrompt(MainStruct* mainStruct)
{
